...
class AnomalyClassificationEvents(Base):
    ...
    def detect_flatline(self, min_duration: str = "1m", tolerance: float = 1e-6) -> pd.DataFrame:
    ...
    def detect_oscillation(self, window: str = "1m", min_crossings: int = 6) -> pd.DataFrame:
    ...
    def classify_anomalies(self, window: str = "10m", z_threshold: float = 3.0) -> pd.DataFrame:
