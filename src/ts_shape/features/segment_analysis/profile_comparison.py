...
class ProfileComparison(Base):
    ...
    def _get_metric_columns(
        ...
        non_metric = {"uuid", "segment_value", "segment_index", "window_start", "window_end", "sample_count"}
    ...
    def compute_distance_matrix(
        ...
        if distance_metric not in metric_map:
            raise ValueError(
                f"Unknown distance_metric: {distance_metric}. " f"Use 'euclidean', 'cosine', or 'manhattan'."
            )
