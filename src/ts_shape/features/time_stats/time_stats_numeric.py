...
class TimeGroupedStatistics(Base):
    ...
    def calculate_statistic(
        cls, dataframe: pd.DataFrame, time_column: str, value_column: str, freq: str, stat_method: str
    ) -> pd.DataFrame:
        """
    ...
    def calculate_statistics(
        cls, dataframe: pd.DataFrame, time_column: str, value_column: str, freq: str, stat_methods: list
    ) -> pd.DataFrame:
        """
    ...
    def calculate_custom_func(
        cls, dataframe: pd.DataFrame, time_column: str, value_column: str, freq: str, func
    ) -> pd.DataFrame:
        """
