...
class IntegerFilter(Base):
    ...
    def filter_value_integer_match(
        cls, dataframe: pd.DataFrame, column_name: str = "value_integer", integer_value: int = 0
    ) -> pd.DataFrame:
    ...
    def filter_value_integer_between(
        cls, dataframe: pd.DataFrame, column_name: str = "value_integer", min_value: int = 0, max_value: int = 100
    ) -> pd.DataFrame:
