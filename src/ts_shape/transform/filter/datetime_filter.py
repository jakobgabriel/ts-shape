...
class DateTimeFilter(Base):
    ...
    def filter_between_dates(
        cls, dataframe: pd.DataFrame, column_name: str = "systime", start_date: str = None, end_date: str = None
    ) -> pd.DataFrame:
        """
    ...
    def filter_between_datetimes(
        cls, dataframe: pd.DataFrame, column_name: str = "systime", start_datetime: str = None, end_datetime: str = None
    ) -> pd.DataFrame:
        """
