...
def test_production_by_part_basic(sample_production_data):
    ...
    result = tracker.production_by_part(part_id_uuid="part_number", counter_uuid="production_counter", window="1h")
...
def test_daily_production_summary(sample_production_data):
    ...
    tracker = PartProductionTracking(sample_production_data)
    result = tracker.daily_production_summary(part_id_uuid="part_number", counter_uuid="production_counter")
...
def test_production_totals(sample_production_data):
    ...
    result = tracker.production_totals(
        part_id_uuid="part_number", counter_uuid="production_counter", start_date="2024-01-01", end_date="2024-01-01"
    )
...
def test_production_tracking_empty_data():
    ...
    result = tracker.production_by_part(part_id_uuid="part_number", counter_uuid="production_counter")
...
def test_cycle_time_by_part_basic(sample_cycle_data):
    ...
    result = tracker.cycle_time_by_part(part_id_uuid="part_number", cycle_trigger_uuid="cycle_trigger")
...
def test_cycle_time_statistics(sample_cycle_data):
    ...
    tracker = CycleTimeTracking(sample_cycle_data)
    result = tracker.cycle_time_statistics(part_id_uuid="part_number", cycle_trigger_uuid="cycle_trigger")
...
def test_detect_slow_cycles(sample_cycle_data):
    ...
    result = tracker.detect_slow_cycles(
        part_id_uuid="part_number", cycle_trigger_uuid="cycle_trigger", threshold_factor=1.5
    )
...
def test_cycle_time_trend(sample_cycle_data):
    ...
    result = tracker.cycle_time_trend(
        part_id_uuid="part_number", cycle_trigger_uuid="cycle_trigger", part_number="PART_A", window_size=5
    )
...
def test_hourly_cycle_time_summary(sample_cycle_data):
    ...
    tracker = CycleTimeTracking(sample_cycle_data)
    result = tracker.hourly_cycle_time_summary(part_id_uuid="part_number", cycle_trigger_uuid="cycle_trigger")
...
def test_cycle_tracking_with_integer_trigger():
    ...
    result = tracker.cycle_time_by_part(
        part_id_uuid="part_number", cycle_trigger_uuid="cycle_count", value_column_trigger="value_integer"
    )
...
def test_shift_production_with_parts():
    ...
    result = reporter.shift_production(counter_uuid="production_counter", part_id_uuid="part_number")
...
def test_complete_production_workflow(sample_production_data, sample_cycle_data):
    ...
    daily_prod = prod_tracker.daily_production_summary(part_id_uuid="part_number", counter_uuid="production_counter")
    assert not daily_prod.empty

    # 2. Cycle time analysis
    cycle_tracker = CycleTimeTracking(sample_cycle_data)
    cycle_stats = cycle_tracker.cycle_time_statistics(part_id_uuid="part_number", cycle_trigger_uuid="cycle_trigger")
